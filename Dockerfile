...
#
# Generated on 2023-06-07T15:14:03Z by kres latest.
...
RUN FILES="$(goimports -l -local github.com/siderolabs/importvet/ .)" && test -z "${FILES}" || (echo -e "Source code is not formatted with 'goimports -w -local github.com/siderolabs/importvet/ .':\n${FILES}"; exit 1)
